...
export default {
    ...
    methods: {
        ...
        changeActiveButton(event) {
            ...
            } else if ((event.target == this.$refs.nextPagePaginationButton && this.activeButton == 1) || (event.target == this.$refs.previousPagePaginationButton && this.activeButton == 3) || ((event.target == this.$refs.thirdPaginationButton || event.target == this.$refs.nextPagePaginationButton) && this.thirdButtonValue != Math.ceil(this.allPubliLength / 10)) || (event.target == this.$refs.lastPagePaginationButton && !this.appearThirdButton) || (event.target == this.$refs.secondPaginationButton && this.activeButton == 1) || (event.target == this.$refs.secondPaginationButton && this.activeButton == 3)) {
